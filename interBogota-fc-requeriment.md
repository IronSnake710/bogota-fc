# Bogota FC - Estructura del Proyecto Web

## Alcance
Plan de trabajo enfocado solo en la estructura del proyecto (IA / arquitectura de contenido) para la web oficial de un club ficticio llamado **Bogota FC**, tomando como referencia patrones comunes en sitios de clubes profesionales.
